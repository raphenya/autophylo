...
from autophylo import myClass

if __name__ == "__main__" and '__file__' in globals():
	cpu_count=os.cpu_count()
	parser = argparse.ArgumentParser(prog="tree_builder",description="Program to automatically build a phylogentic tree given a protein sequence(s)")
	...
	# filters
	parser.add_argument('--specific_taxa', dest="specific_taxa",type=str.lower,
	choices = ["actinobacteriota","bacteroidota","desulfobacterota","firmicutes","proteobacteria","synergistota","verrucomicrobiota","fusobacteria"],
	default="",help = "specify taxonomy (default = '')")
